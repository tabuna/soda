...
final class NamingRuleDefinitions
{
    ...
    {
        return [
            RuleDefinitionPack::tie(new RuleIdentity('avoid_redundant_naming', $section), new RulePresentation('Redundant naming:', 'warning'), new RuleScoring(80)),

            RuleDefinitionPack::tie(new RuleIdentity('boolean_methods_without_prefix', $section), new RulePresentation('Boolean method prefixes:', 'warning'), new RuleScoring(0)),
        ];
    }
}
